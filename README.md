...
[+] Make Sure You Add All These Mandatory Vars. 
    ...
    [-] STRINGSESSION : Your String Session, You can get this From Repl or BY running String_Gen.py File Locally
        * Note: If self hosting, you must run gen_string.py locally
