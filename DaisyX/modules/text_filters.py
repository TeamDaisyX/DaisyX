...
async def save_filters(_, message):
    if len(message.command) < 2 or not message.reply_to_message:
        ...
        await message.reply_text("__**You can only save text or stickers as text filters.**__\n\n NOTE: **TRY /addfilter FOR OTHER FILE TYPES**")
...
@app.on_message(filters.incoming & filters.text & ~filters.private & ~filters.channel & ~filters.bot)
