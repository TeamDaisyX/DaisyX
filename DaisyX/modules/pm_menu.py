...
STICKERS = (
    "CAACAgEAAxkBAAEJgy1ghGGTzWMjfhO7Ru7hOS4oVqUGFQACMQEAAmdEKETJPq-0Q1fa2x8E",
)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/MissValentina"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/missvalentinaupdates"),
        InlineKeyboardButton("👥 Support Grup", url="https://t.me/missvalentinaupdates"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add MissValentina to your group",
            url=f"https://telegram.me/MissValentinaV2Bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/MissValentinaV2Bot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
